...
def create_sample_data():
    nodes = [
        ...
        {"id": 5, "label": "tumor-related conditions", "group": "disease characteristics"},
        ...
        {"id": 10, "label": "medical histories", "group": "disease characteristics"},
        ...
        {"id": 15, "label": "tumor blood supply", "group": "tumor-related conditions"},
        {"id": 16, "label": "number of tumors in the liver", "group": "tumor-related conditions"},
        {"id": 17, "label": "tumor diameter", "group": "tumor-related conditions"},
        {"id": 18, "label": "tumor volume", "group": "tumor-related conditions"},
        {"id": 19, "label": "tumor capsule", "group": "tumor-related conditions"},
        {"id": 20, "label": "distance from tumor to hepatic capsule", "group": "tumor-related conditions"},
        {"id": 21, "label": "vascular invasion", "group": "tumor-related conditions"},
        {"id": 22, "label": "PVTT", "group": "tumor-related conditions"},
        {"id": 23, "label": "liver cancer stage", "group": "tumor-related conditions"},
        {"id": 24, "label": "hepatic artery diameter", "group": "tumor-related conditions"},
        {"id": 25, "label": "Child-Pugh score", "group": "tumor-related conditions"},
        ...
        {"id": 44, "label": "oxaliplatin dose", "group": "administration processes"},
        {"id": 45, "label": "oxaliplatin preparation time", "group": "administration processes"},
        ...
        {"id": 51, "label": "number of TACE procedures", "group": "medical histories"},
        {"id": 52, "label": "liver cancer surgery history", "group": "medical histories"},
        {"id": 53, "label": "liver cancer transplantation history", "group": "medical histories"},
        {"id": 54, "label": "drinking history", "group": "medical histories"},
        {"id": 55, "label": "number of HAIC procedures", "group": "medical histories"},
        {"id": 56, "label": "chronic cancer pain", "group": "medical histories"},
        ...
        {"id": 63, "label": "history of abdominal pain after TACE", "group": "individual characteristics"},
